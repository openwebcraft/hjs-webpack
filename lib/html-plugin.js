...
function defaultHtml (incomingData) {
  ...
  add('<script>function loadJS(){' +
  'var d=document.createElement("script");' +
  'd.src="' + sep + data.main + '",' +
  'document.body.appendChild(d)}' +
  'window.addEventListener?window.addEventListener("load",loadJS,' +
  '!1):window.attachEvent?window.attachEvent("onload",loadJS)' +
  ':window.onload=loadJS;</script>')
  add('</body>')
  return result.join('')
}
