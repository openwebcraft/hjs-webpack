...
function defaultHtml (incomingData) {
  ...
  add('</body>')
  add('<script>function downloadJSAtOnload(){var d=document.createElement("script");d.src="' + sep + data.main + '",document.body.appendChild(d)}window.addEventListener?window.addEventListener("load",downloadJSAtOnload,!1):window.attachEvent?window.attachEvent("onload",downloadJSAtOnload):window.onload=downloadJSAtOnload;</script>')
  return result.join('')
}
